...
const DEFAULT_ACTION_CLOCK_SECONDS := 15
const ACTION_CLOCK_OPTIONS := [10, 15, 20, 30]
...
@export_enum("10 Seconds:10", "15 Seconds:15", "20 Seconds:20", "30 Seconds:30") var action_clock_seconds: int = DEFAULT_ACTION_CLOCK_SECONDS
